...
class InstagramUnfollower:
    ...
    def __init__(self, username, password, unfollowing_speed):
        ...
        self.driver = webdriver.Chrome('C:/Users/Phanatagama/Downloads/chromedriver.exe') #specifies the driver which you want to use)
    ...
    def find_followings(self, driver, buttons): # this functions finds the accounts who are followed by us
        ...
        driver.find_element_by_xpath('//svg[@aria-label="Close"]').click() #closes the following window
    ...
    def find_followers(self, driver, buttons): # this functions finds the accounts who are following us
        ...
        driver.find_element_by_xpath('//svg[@aria-label="Close"]').click() #closes the follower window
    ...
    def unfollow_target_users(self, unfollowing_speed):
        ...
        self.following_window.find_element_by_xpath('//svg[@aria-label="Close"]').click()